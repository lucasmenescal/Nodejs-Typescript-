...
import stormGlassWeather3HoursFixture from '@test/fixtures/stormglass_3_hours.json';
import stormGlassNormalized3HoursFixtures from '@test/fixtures/stormGlass_normalized_response_3_hours.json';
jest.mock('axios');


describe('StormGlass client', () => {
  it('should reutrn the normalized forecast from the StormGlass service', async () => {
    const lat = -33.792726;
